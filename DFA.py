...
subsequent lines are result and actions for each initial_state/letter combination

"""

# parse the input data to produce a DFA alphabet, a list of True/False actions for each initial_state and a dictionary of
# operations for each initial_state
